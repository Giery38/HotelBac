        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserEntity_Genders_GenderId",
                        column: x => x.GenderId,
                        principalTable: "Genders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserEntity_PositionTypes_PositionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Rooms_RoomViews_ViewId",
                        column: x => x.ViewId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookingEntityGuestEntity", x => new { x.BookingsId, x.GuestsId });
                    table.ForeignKey(
                        name: "FK_BookingEntityGuestEntity_Bookings_BookingsId",
                        column: x => x.BookingsId,
                        principalTable: "Bookings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookingEntityGuestEntity_UserEntity_GuestsId",
                        column: x => x.GuestsId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookingEntityRoomEntity", x => new { x.BookingsId, x.RoomsId });
                    table.ForeignKey(
                        name: "FK_BookingEntityRoomEntity_Bookings_BookingsId",
                        column: x => x.BookingsId,
                        principalTable: "Bookings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookingEntityRoomEntity_Rooms_RoomsId",
                        column: x => x.RoomsId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HotelEntityServiceEntity", x => new { x.HotelsId, x.ServicesId });
                    table.ForeignKey(
                        name: "FK_HotelEntityServiceEntity_Hotels_HotelsId",
                        column: x => x.HotelsId,
                        principalTable: "Hotels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HotelEntityServiceEntity_Services_ServicesId",
                        column: x => x.ServicesId,
                        principalTable: "Services",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookingEntityGuestEntity_GuestsId",
                table: "BookingEntityGuestEntity",
                column: "GuestsId");

            migrationBuilder.CreateIndex(
                name: "IX_BookingEntityRoomEntity_RoomsId",
                table: "BookingEntityRoomEntity",
                column: "RoomsId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HotelEntityServiceEntity_ServicesId",
                table: "HotelEntityServiceEntity",
                column: "ServicesId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserEntity_GenderId",
                table: "UserEntity",
                column: "GenderId");

            migrationBuilder.CreateIndex(
                name: "IX_UserEntity_PositionId",
                table: "UserEntity",
                column: "PositionId");
        }
